...
export async function renderAreaTecnicaPost(slug = 'senalizacion-de-parkings') {
  ...
  const layoutHTML = `
    <main>
      ...
      <div id="video-popup-modal" style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 10000000; align-items: center; justify-content: center; padding: 1rem;">
        <div id="video-popup-backdrop" style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; width: 100vw; height: 100vh; background-color: rgba(0,0,0,0.92); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); z-index: 10;"></div>
        <div style="max-width: 960px; width: 90vw; padding: 0; background: transparent; border: none; box-shadow: none; overflow: visible; z-index: 20; position: relative;">
