            ...
            <div class="container-fluid mega-menu-proyectos-inner">
              ${content.proyectos.slice(0, 3).map(proj => `
                <div class="mega-menu-proyectos-card">
                  <a href="#proyectos" style="display: block; text-decoration: none; color: inherit;">
...
const renderHero = () => `
  <section id="hero" class="ark-hero">
    ...
    <div class="ark-hero-right">
      ...
      <div class="ark-cta-card gsap-reveal">
        <p>¿Listo para transformar la identidad corporativa de tu empresa a nivel nacional?</p>
        <a href="#contacto" class="btn-regius" style="width: 100%; padding: 1.5rem;">
          <div class="btn-regius-bg"></div>
          <div class="btn-regius-text-wrapper">
            <div class="btn-regius-text _1" style="font-size: 1.1rem;">EMPEZAR AHORA →</div>
            <div class="btn-regius-text _2" style="font-size: 1.1rem;">EMPEZAR AHORA →</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <section id="proceso" style="height: 100vh; overflow: hidden; display: flex; align-items: center;">
      <div class="container-fluid grid grid-cols-2 gap-6" style="width: 100%;">
        ...
        <div class="sticky-sidebar" style="position: relative; display: flex; flex-direction: column; justify-content: flex-start; padding-top: 0vh; padding-right: 4rem;">
          ...
          <div id="lottie-bar" style="position: absolute; top: 75%; left: 50%; transform: translate(-50%, -50%); width: 100%; height: 120%; z-index: 0; pointer-events: none;"></div>
...
const initAnimations = () => {
  ...
  const initProcessAnimation = () => {
    ...
    // Initialize custom Canvas WebGL particles field
